...
<head>
	...
	<link href="../../resources/css/BusinessInForm.css" rel="stylesheet">
...
<body>
	...
	<c:import url="../common/header.jsp"/>
              <form class="form-horizontal" method="post" name="signup" id="signup" name="bjoinForm" id="bjoinForm"
                    action="${pageContext.request.contextPath }/insert1.me" >        
  <div class="container">
    <div class="row">
      <div class="col-md-8">
        <section>      
          <h3 class="entry-title"><span>기업 회원 가입</span> </h3>
          <hr>
            <div class="form-group">
                  ...
                  <div class="col-md-8 col-sm-9">
                      ...
                      <input type="text" class="form-control" name="b_id" id="b_id" placeholder="아이디" value="">
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 col-sm-8">
              <div class="input-group">
                ...
                <input type="password" class="form-control" name="b_password" id="b_password" placeholder="비밀번호 입력" value="">
             </div>   
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-5 col-sm-10">
              <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                <input type="password" class="form-control" name="bpassword" id="bpassword" placeholder="비밀번호 재입력" value="">
              </div>  
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-3">사업자명<span class="text-danger">*</span></label>
            <div class="col-md-8 col-sm-9">
              <input type="text" class="form-control" name="b_name" id="b_name" placeholder="사업자명을 입력하세요" value="">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-3">상호명<span class="text-danger">*</span></label>
            <div class="col-md-8 col-sm-9">
              <input type="text" class="form-control" name="b_shopname" id="b_shopname" placeholder="상호명을 입력하세요" value="">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-5">사업자 번호<span class="text-danger">*</span></label>
            <div class="col-md-8 col-sm-9">
              <input type="text" class="form-control" name="b_num" id="b_num" placeholder="사업자번호를 입력하세요" value="">
              <button>인증하기</button>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label class="control-label col-sm-3">대표자명<span class="text-danger">*</span></label>
            <div class="col-md-8 col-sm-9">
              <input type="text" class="form-control" name="b_ceoname" id="b_ceoname" placeholder="대표자명을 입력하세요" value="">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-5">사업자 대표번호<span class="text-danger">*</span></label>
            <div class="col-md-8 col-sm-9">
              <input type="text" class="form-control" name="b_mainnumber" id="b_mainnumber" placeholder="사업자 대표번호" value="">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-3">담당자<span class="text-danger">*</span></label>
            <div class="col-md-8 col-sm-9">
              <input type="text" class="form-control" name="b_incharge" id="b_incharge" placeholder="담당자명을 입력하세요" value="">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-5">담당자 연락처<span class="text-danger">*</span></label>
            <div class="col-md-8 col-sm-9">
              <input type="text" class="form-control" name="b_incharge_p" id="b_incharge_p" placeholder="담당자 연락처를 입력하세요" value="">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-3">E-Mail<span class="text-danger">*</span></label>
            <div class="col-md-8 col-sm-9">
              <input type="text" class="form-control" name="b_email" id="b_email" placeholder="E-Mail을 입력하세요" value="">
              <button>인증하기</button>
            </div>
          </div>
         </section>
...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalLong1">
		...
		function checkBtn(btnNo){
         ...
         <div class="form-group">
                  ...
                  class="btn btn-primary" id="goMain" onclick="goMain();">
                    ...
                    id="bjoinBtn" onclick="insertBusiness();">
                  </div>
 	...
 	$("#joinForm").submit(function(event) {
		if ($("#b_password").val() == "" || $("#b_id").val() == "")
			alert("아이디나 비밀번호는 필수 값입니다.");
		else if ($('#b_password').val() != $('#bpassword').val())
 ...
 // 참조 API : http://postcode.map.daum.net/guide
	...
	$('#idCheck').click(function(){
		$.ajax({
			url : "${pageContext.request.contextPath}/idDup2.me",
			type: "post",
			data : { b_id : $('#b_id').val()},
