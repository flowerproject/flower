    ...
    <div class="container">
        <div class="overlay" id="overlay">
          <div class="sign-in" id="sign-in" style="padding: 0px;">
            ...
            <button class="switch-button" id="slide-right-button">회원가입</button>
          </div>
        ...
        <div class="form">
          ...
          <div class="sign-up" id="sign-up-info">
            ...
            <div>
            <input type="radio" value="일반회원" checked> 일반회원 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" value="기업회원"> 기업회원
            <!-- 이거 둘중 하나만 선택되게 해야됨 일반이면 일반으로 기업이면 기업으로.-->
