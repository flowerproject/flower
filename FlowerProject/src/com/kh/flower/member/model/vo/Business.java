...
public class Business {
	...
	public Business(int b_no, String b_id, String b_password, String b_name, String b_shopname, String b_num,
			String b_address, String b_ceoname, String b_mainnumber, String b_incharge, String b_incharge_p,
	...
	// 기업회원 회원가입용
	public Business(String b_id, String b_password, String b_name, String b_shopname, String b_num, String b_address,
	...
	public void setB_address(String b_adress) {
		this.b_address = b_adress;
	}
	...
	public String toString() {
		return "Business [b_no=" + b_no + ", b_id=" + b_id + ", b_password=" + b_password + ", b_name=" + b_name
				+ ", b_shopname=" + b_shopname + ", b_num=" + b_num + ", b_address=" + b_address + ", b_ceoname="
